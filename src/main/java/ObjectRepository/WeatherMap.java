...
public class WeatherMap {
	...
	public static String  chk_search_city = "//input[@id='{config.city_name}' and @type='checkbox']";
	public static String  lbl_degree_temp_on_map = "//div[@title='{config.city_name}']//span[@class='tempRedText']";
}
